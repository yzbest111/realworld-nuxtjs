  ...
  methods: {
    async onSubmit() {
      try {
        ...
        console.log(data); // 保存用户的登陆状态

        this.$store.commit('setUser', data.user); // 为了防止刷新页面导致数据丢失，我们需要把数据持久化
